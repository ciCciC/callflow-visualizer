...
export const LIGHT_GRAY: CSSResult = css`#e6e6e6`;
export const TRANSPARENT_LIGHT_GREY: CSSResult = css`rgba(230, 230, 230, 0.52)`;
export const BOX_SHADOW: CSSResult = css`0 8px 16px 0 rgba(0, 0, 0, 0.2)`;
export const BOX_LIGHT_SHADOW: CSSResult = css`0 0 4px 0 rgba(0, 0, 0, 0.2)`;
